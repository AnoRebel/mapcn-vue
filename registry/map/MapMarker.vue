...
function handleClick(e: MouseEvent) { props.onClick?.(e) }
function handleMouseEnter(e: MouseEvent) { props.onMouseEnter?.(e) }
function handleMouseLeave(e: MouseEvent) { props.onMouseLeave?.(e) }
...
function createMarker() {
  ...
  if (props.rotationAlignment !== undefined) markerOptions.rotationAlignment = props.rotationAlignment
  ...
  if (props.subpixelPositioning !== undefined) markerOptions.subpixelPositioning = props.subpixelPositioning
