...
<template>
  <div class="relative">
    ...
    <div class="container flex flex-col items-center text-center">
      <h1
        class="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight animate-fade-up delay-100"
      >
        <span
      ...
      <p
        class="mt-6 text-foreground/80 text-lg md:text-xl leading-relaxed animate-fade-up delay-200 max-w-lg"
      >
      ...
      <div class="mt-8 animate-fade-up delay-300 w-full max-w-xl">
        <div
          class="bg-card border border-border rounded-lg shadow-xs overflow-hidden"
        >
          <div
            class="flex items-center gap-1.5 px-3 py-2 border-b border-border/50"
          >
      ...
      <div
        class="mt-8 flex flex-wrap justify-center items-center gap-3 animate-fade-up delay-400"
      >
