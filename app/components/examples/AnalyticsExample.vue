...
<template>
  ...
  >
    ...
    >
      <div
        class="tracking-wider text-[10px] text-muted-foreground uppercase mb-1"
      >
        Active Users
      </div>
    ...
    <div
      class="absolute bottom-3 left-3 z-10 bg-background/95 backdrop-blur-md rounded-lg px-3 py-2 border border-border/50 shadow-lg"
    >
