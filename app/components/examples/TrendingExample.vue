          ...
          <MarkerContent>
            <div class="relative flex items-center justify-center">
              <div
                ...
                :class="
                  i === 0
                    ? 'bg-orange-500/30 size-18'
                    : i === 1
                      ? 'bg-rose-500/30 size-14'
                      : 'bg-amber-500/30 size-12'
                "
              />
              <div
                :class="[
                  ...
                  i === 0
                    ? 'bg-linear-to-br from-orange-500 to-red-500 shadow-orange-500/50'
                    : i === 1
                      ? 'bg-linear-to-br from-rose-500 to-pink-500 shadow-rose-500/50'
              ...
              >
                <Flame
                  :class="
                    i === 0 ? 'size-3.5' : i === 1 ? 'size-3' : 'size-2.5'
                  "
                  class="text-white"
                />
              </div>
