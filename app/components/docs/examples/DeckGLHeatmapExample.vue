...
<template>
  <div class="space-y-4">
    ...
    <p class="text-sm text-muted-foreground">
      HeatmapLayer showing incident density. 1000 randomly distributed points aggregated into a density visualization.
    </p>
  </div>
</template>
