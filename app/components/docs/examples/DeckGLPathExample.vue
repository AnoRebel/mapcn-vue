...
<template>
  <div class="space-y-4">
      ...
      <CardContent class="p-4 space-y-4">
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span class="text-sm text-muted-foreground">{{ widthScale.toFixed(1) }}x</span>
          </div>
          <input
    ...
    <p class="text-sm text-muted-foreground">
      PathLayer for rendering GPS trails, routes, and paths with customizable width and colors.
      Click on any trail to select it.
    </p>
  </div>
</template>
