...
function calculateBounds(geojson: any): MapLibreGL.LngLatBounds | null {
...
<template>
  ...
  <div v-if="hoveredPark" class="absolute bottom-3 left-3 z-10 rounded-md bg-background/90 backdrop-blur px-3 py-2 text-sm font-medium border">
    {{ hoveredPark }}
  </div>
</template>
