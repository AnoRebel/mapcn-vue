...
<template>
  <div class="space-y-4">
      ...
      <CardContent class="p-4 space-y-4">
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span class="text-sm text-muted-foreground">{{ Math.round(coverage * 100) }}%</span>
          </div>
          <input
        ...
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span class="text-sm text-muted-foreground">{{ elevationScale }}</span>
          </div>
          <input
    ...
    <p class="text-sm text-muted-foreground">
      ...
      Perfect for aggregating data into hexagonal bins. Adjust coverage to see hexagon sizing,
      and elevation scale for 3D effect.
    </p>
    <p class="text-xs text-muted-foreground">
      Requires <code>h3-js</code> library to convert between lat/lng and H3 addresses.
    </p>
  </div>
</template>
