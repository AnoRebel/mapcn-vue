  ...
  features: [
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [[
          [-73.98, 40.77], [-73.95, 40.77], [-73.95, 40.80], [-73.98, 40.80], [-73.98, 40.77]
        ]]
      }
    },
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [[
          [-73.99, 40.78], [-73.97, 40.78], [-73.97, 40.81], [-73.99, 40.81], [-73.99, 40.78]
        ]]
      }
    },
  ]
  ...
  features: [
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [[
          [-73.986, 40.748], [-73.985, 40.748], [-73.985, 40.749], [-73.986, 40.749], [-73.986, 40.748]
        ]]
      }
    },
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [[
          [-73.975, 40.751], [-73.974, 40.751], [-73.974, 40.752], [-73.975, 40.752], [-73.975, 40.751]
        ]]
      }
    },
  ]
  ...
  features: [
    {
      ...
      geometry: {
        type: 'LineString',
        coordinates: [
          [-74.00, 40.72], [-73.99, 40.74], [-73.98, 40.76], [-73.97, 40.78]
        ]
      }
    },
  ]
...
const layers = ref({
  ...
  buildings: { visible: true, opacity: 0.7, name: 'Buildings', color: '#dc2626' },
...
const mapStyles = computed(() => {
  ...
  return { light: base as any, dark: base as any }
})
</script>
...
<template>
  <div class="space-y-4">
    ...
    <p class="text-sm text-muted-foreground">
      Interactive layer switcher demonstrating dynamic layer visibility, opacity control,
      and basemap style switching. Toggle layers on/off and switch between light, dark, and satellite views.
    </p>
  </div>
</template>
