...
<template>
  <div class="space-y-4">
    ...
    <div class="h-[400px] w-full rounded-lg overflow-hidden border">
      <Map :center="[-74.0, 40.75]" :zoom="12" class="h-full">
        <MapRoute
    ...
    <p class="text-sm text-muted-foreground">
      Multi-stop route optimization using a traveling salesman algorithm. Add
      stops, reorder them, and calculate the most efficient route.
    </p>
  </div>
</template>
