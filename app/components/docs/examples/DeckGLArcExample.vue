...
<template>
  <div class="space-y-4">
    ...
    <p class="text-sm text-muted-foreground">
      ArcLayer showing international flight routes. Gold lines show origin, blue
      lines show destination. Uses great circle arcs to follow Earth's
      curvature.
    </p>
  </div>
</template>
