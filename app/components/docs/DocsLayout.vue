    ...
    <main class="flex-1 min-w-0">
      <div class="px-4 sm:px-6 lg:px-8 xl:px-12 py-8 lg:py-12">
        <div class="max-w-3xl mx-auto w-full min-w-0">
          ...
          <div v-if="prev || next" class="flex items-center justify-between gap-4 mt-12 pt-8 border-t">
            <NuxtLink
              v-if="prev"
              :to="prev.href"
            ...
            >
              ...
              <span class="text-sm font-medium group-hover:underline underline-offset-4">
                {{ prev.title }}
              </span>
            </NuxtLink>
