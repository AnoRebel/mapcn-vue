...
import { Zap, Moon, Puzzle, Code, Box, Layers } from "lucide-vue-next";
...
useSeoMeta({
  title: "Introduction",
  description:
    "Beautiful, accessible map components for Vue/Nuxt. Built on MapLibre GL, styled with Tailwind CSS, designed for shadcn-vue.",
});
...
<template>
  ...
  >
    <DocsSection>
      <p>
        <strong class="text-foreground">mapcn-vue</strong> provides beautifully
        designed, accessible, and customizable map components. Built on
    ...
    <DocsSection title="Why mapcn-vue?">
      <p>
        ...
        Most solutions require complex configurations, API keys, or heavy
        wrapper libraries. mapcn-vue solves this:
      </p>
      <ul>
        <li>
          <strong class="text-foreground">One Command:</strong> Run the install,
          get a working map. No config files, no API keys, no setup.
        </li>
        <li>
          <strong class="text-foreground">Own Your Code:</strong> Copy the
        ...
        <li>
          <strong class="text-foreground">Works Anywhere:</strong> Bring your
          own tiles — MapTiler, Carto, OSM, or any MapLibre-compatible source.
        </li>
      </ul>
    </DocsSection>
    ...
    <DocsSection title="Why MapLibre Directly?">
      <p>
        ...
        directly instead of wrapper libraries. This keeps components close to
        the underlying API — when you copy a mapcn-vue component, you fully own
        the map instance without extra framework dependencies.
      </p>
      <p>
    ...
    <DocsSection title="Features">
      <div class="grid gap-4 sm:grid-cols-2 mt-4 not-prose">
        <div
    ...
    <DocsSection title="Credits">
      <p>
        <strong class="text-foreground">mapcn-vue</strong> is the official
        Vue/Nuxt port of
        <DocsLink href="https://github.com/AnmolSaini16/mapcn" external
          >mapcn</DocsLink
        >, originally built by
        <DocsLink href="https://github.com/AnmolSaini16" external
          >Anmoldeep Singh</DocsLink
        >
